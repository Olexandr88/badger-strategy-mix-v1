...
1. Open the [`scripts/production_setup.py`](https://github.com/Badger-Finance/strategy-convex-staking-optimizer/blob/main/scripts/3_production_setup.py) file and change the addresses for your strategy and vault mainnet addresses on lines 29 and 30.
...
3. Run [`scripts/production_setup.py`](https://github.com/Badger-Finance/strategy-convex-staking-optimizer/blob/main/scripts/3_production_setup.py) with the following command:
